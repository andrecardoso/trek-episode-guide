...
public class TrekButton extends Button {
	
	private static Typeface trekTypeface;
	
	public TrekButton(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
	}

	public TrekButton(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public TrekButton(Context context) {
		super(context);
	}
